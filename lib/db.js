...
const put_Proposal = async ({id, chain, proposal_id, status, name, height, voting_end_time}) => {
  const [instance, created] = await Proposal.upsert({id, chain, proposal_id, status, name, height, voting_end_time});
}
