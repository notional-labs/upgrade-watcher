...
const fetch_future_block_time  = async (chain, future_height) => {
  ...
  const current_time = parseDate(data["result"]["latest_block_time"]["latest_block_height"]);
...
module.exports = {fetch_proposal, fetch_latest_block_height, fetch_future_block_time};
